...
var (
	...
	READONLY       bool   // is dlog in readonly mode
...
func init() {
	...
	flag.StringVar(&SITENAME, "sitename", "dlog", "Site name is the name that appears on the header beside the logo and in the title tag")
	...
	flag.BoolVar(&READONLY, "readonly", false, "Should dlog hide write operations, read-only means all write operations will be disabled")
